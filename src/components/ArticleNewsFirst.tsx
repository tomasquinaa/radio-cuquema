  ...
  <article className="bg-white shadow-md p-6 mb-8 mx-auto border border-gray-200">
    <div className="flex">
      ...
      <div className="relative mr-6">
        <img src={exportImg.sinprof} alt="Notícia SINPROF" className="w-32 h-32 object-contain" />
      </div>
  ...
  <hr /><br />
        ...
        <div className="text-gray-700">
          <audio controls className="w-full mb-4">
            <source src="https://radiocuquema.com/wp-content/uploads/2021/04/GREVE-1.mp3" type="audio/mpeg" />
            Seu navegador não suporta o elemento de áudio.
          </audio>
          <p>O Sindicato Nacional dos Professores decretou, no sábado (17.04.2021), greve em todo território nacional a partir do dia 26 de Abril do corrente.</p>
        </div>
      </div>
    </div>
  </article>
